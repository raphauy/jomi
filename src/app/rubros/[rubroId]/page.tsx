...
export default async function RubroPage({ params }: Props) {
    ...
    return (
        <section className={cn(helveticaLight.className, "fondo-cheers z-0 relative w-full h-screen pt-20 text-white flex flex-col items-center gap-10 text-center bg-cover")} >
